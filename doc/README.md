...
Endpoint (кінцева вершина) – це програма, підпрограма, чи функція, яка закінчує pipeline запиту, безпосередньо викликає CRUD операції для ресурсів та формує відповідь.
